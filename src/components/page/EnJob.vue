<template>
    <div class="vuejob">
        <h2 style="text-align: center" id="headline">COSMOS <a href="http://www.pansheng.me#/job" class="none">(http://www.pansheng.me)</a></h2>
        <div class="container">
            <div class="info">
                <p><span class="left">Name：</span><span>COSMOS</span></p>
                <p><span class="left">Full-time：</span><span>Hunan Vocational College of Technology</span></p>
                <p><span class="left">Part-time：</span><span>Wuhan Polytechnics University</span></p>
                <p><span class="left">WeChat：</span><span>宇宙黑暗天使</span></p>
                <p><span class="left">Telephone Number：</span><span>****</span></p>
                <p><span class="left">E-mail：</span><span class="right">songsongs520@163.com</span></p>
                <p><span class="left">Current Address：</span><span class="right">Longgang, Shenzhen, Guangdong </span></p>
            </div>
            <div class="job">
                <a href="#job" data-scroll class="noLine"><h3 id="job">Job Intention</h3></a>
                <hr>
                <p>Web Developer</p>
            </div>
            <div class="account">
                <a href="#account" data-scroll class="noLine"><h3 id="account">Social Account </h3></a>
                <hr>
                <ul>
                    <li>github Home： <a href="https://github.com/yuzhouzhijia520">github.com/yuzhouzhijia520</a></li>
                    <li>My Blog Home： <a href="http://pansheng.me/">http://pansheng.me/</a></li>            
                </ul>
            </div>
            <div class="trainee">
                <a href="#done" data-scroll class="noLine"><h3 id="done">The Behavior At School </h3></a>
                <hr>
                <p class="date">2012.9 -- 2014.12</p>
                <ul><li>Studied in the HDU OJ <a href="http://acm.hdu.edu.cn/">http://acm.hdu.edu.cn/</a></li>
                    <li>Studied in the UVA OJ <a href="https://uva.onlinejudge.org/">https://uva.onlinejudge.org/</a></li>
                    <li>the second prize in School of software that Software Design Competition  （algorithm of java）</li>
                    <li>the third prize of Blue Bridge Cup Entrepreneurship Talent Design Competition （algorithm of java）</li>
                </ul>
            </div>
             <div class="trainee">
            ...
            <div class="trainee">
                <a href="#done" data-scroll class="noLine"><h3 id="done">Training Experience<span class="company">(Huawei University)</span></h3></a>
                <hr>
                ...
                <ul>
                    <li>Name：Process Training of IDP</li>
                    <li>Content：Huawei IPD process study</li>
                </ul>
            </div>
             <div class="trainee">
                <a href="#done" data-scroll class="noLine"><h3 id="done">Work Experience<span class="company">(HUAWEI)</span></h3></a>
                <hr>
                <p class="date">2014.12 -- 2015.12</p>
                ...
                <ul>
                    ...
                    <li>Related Skills：
                        <br>
                        Private Cloud：(Env)Container deployment of docker+devops+maven+svn+CI ccloud
                        <br>
                        Public Cloud[<a href='https://www.huaweicloud.com'>link</a>]：(Env)Container deployment of docker+k8s+spring boot+git+CI ccloud
                        <br>
                        Responsible Module：appbuilding cloud portal,store Microservice Architecture of web developer.
                        <br>
                        Language：es6、vue、javascript、jquery、bootstrap、bootstrap table、bootstrap editable、css3、less、html5、ajax、webpack,etc that these build tools of Open source.
                    </li>
                </ul>
            </div>
            <div class="post">
            ...
            <div class="post">
                <a href="#post" data-scroll class="noLine"><h3 id="post">Salon</h3></a>
                <hr>
                <ul>
                    <li>
                        <a href="#post" data-scroll class="noLine"><h4 id="post">Salon Of Huawei Cloud</h4></a>
                        <p class="date">Jan 2017</p>
                        <ul>
                            <li>Participated in Huawei Cloud salon study.</li>
                        </ul> 
                    <li>
                        <a href="#post" data-scroll class="noLine"><h4 id="post">Salon Of Tencent Cloud</h4></a>
            ...
            <div class="thx">
                <a href="#selfIntro" data-scroll class="noLine"><h3 id="selfIntro">thank-you</h3></a>
                <hr>
                <p>Thank you for reading my resume and looking forward to creating the future with you!</p>
            </div>
            <div class="skill">About：本页面涉及简单的vue+vue-router+webpack+less</div>
            <p class="footer">简历线上地址：http://www.pansheng.me</p>
        </div>
    </div>
</template>
...
<script>
 ...
 <style lang="less" scoped>
        ...
        .job, .canDo, .done, .selfIntro, .account, .post, .trainee {
